...
\title{Experiment Safety Assessment Document (ESAD) \\ 
  for the Hall B CLAS12 ALERT Experiment \\
  (Run Group L and Run Group T)}
\date{\today}
%
...
Experimental Equipment for the ALERT experiment. ALERT is comprised by experiments in
Run Group L and Run Group T. Many of these subsystems impose similar
...
\input{beamline_vacuum_systems_ALERT}

\input{target_system_ALERT}

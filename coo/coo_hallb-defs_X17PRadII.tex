...
%
\def\HALL{Hall B}
\def\EXPTS{X17/PRad II} 
\def\EXPTSabrev{CLAS12} 
\def\HALLLEADER{Patrick Achenbach}
\def\ACCDIVLIAISON{Katheryne Price} 
\def\PHYSDIVLIAISON{Eugene Pasyuk/Rafayel Paremusyan}
\def\PHYSDIVLIAISONEMAIL{pasyuk@jlab.org/rafopar@jlab.org} 

...
%
\def\HALL{Hall B}
\def\EXPTS{PRad II/X17} 
\def\EXPTSabrev{PRad} 
\def\HALLLEADER{Stepan Stepanyan}
\def\ACCDIVLIAISON{Katheryne Price} 
\def\PHYSDIVLIAISON{Eugene Pasyuk}
\def\PHYSDIVLIAISONEMAIL{pasyuk@jlab.org} 
\def\AWARENESS{SAF111}
\def\FAMILIARITY{SAF121}
% Hall B Accelerator Physics Liaison
\def\AccPhysLiaison{Kirsten Deitrick}

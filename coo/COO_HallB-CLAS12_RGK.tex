...
\input{coo_hallb-CLAS12_defs-rgk.tex}
...
\begin{figure}
%\vspace{180mm}
\includegraphics[width=\textwidth]{coo_HallB_CLAS12_rgk_org.pdf}
...
During operating shifts, 24 hour occupation of the Counting House area will be maintained by the
assigned shift crews in 8 hour shifts. One person per shift is designated as the Shift Leader. The
Shift Leader must be in the Counting House during their shift. The Shift Worker can either be located
onsite in the Counting House or offsite at their home institution (although their presence in the
Counting House is strongly encouraged).\footnote{\label{fn2}The readiness review committee may require more 
personnel depending on the complexity of the experiment. Two person shift crews are the minimum required
for safe operations.}

...
%
\def\HALL{Hall B}
\def\EXPTS{CLAS12 Run Group - M} 
\def\EXPTSabrev{CLAS12} 
\def\HALLLEADER{Marco Battaglieri}
\def\ACCDIVLIAISON{Matthew Mock} 
\def\PHYSDIVLIAISON{Valery Kubarovsky}
\def\PHYSDIVLIAISONEMAIL{vpk@jlab.org} 

...
\input{coo_hallb-CLAS12_defs-alert.tex}
...
\EXPTS\  %(\EXPTSabrev\ ) 
experiment is on the floor. Note that the ALERT run group is comprised by CLAS12
Run Groups L and T. Installation 
...
This experiment uses the standard \HALL\ beamline equipment and the CLAS12 setup with the Central Vertex Tracker (CVT)
removed and replaced by the new ALERT detector comprised of the AHDC tracker and ATOF scintillation detector. The ALERT
acronym stand for \underline{A} \underline{L}ow-\underline{E}nergy \underline{R}ecoil-\underline{T}racker.

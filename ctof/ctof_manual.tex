...
through the expert monitoring suite {\it CDMON}. Details on this suite are
provided in Section~\ref{cdmon}, however this suite is mainly intended for
CTOF system experts.
...
\item Monitor the system performance with the {\it CDMON} expert monitoring suite
(see Section~\ref{cdmon}).
...
The expert monitoring suite for the CTOF system is called {\it CDMON}. This code 
suite is brought up on any Counting House computer by typing ``cdmon''. The suite 
...
of the suite are shown in Fig.~\ref{cdmon-screens}. 
...
\begin{picture}(30,50) 
\put(90,0)
{\hbox{\includegraphics[width=0.60\textwidth,natwidth=610,height=0.60\textheight,
natheight=642]{dummy.pdf}}}
\end{picture} 
\caption{Various screens from the {\it CDMON} expert monitoring suite.}
\label{cdmon-screens}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
checked by taking FADC data in ``raw mode'' using the {\it CDMON} system monitoring 
suite (see Section~\ref{cdmon}).
...
Cole Smith       & (757)-269-5307 & lcsmith@jlab.org   & Hardware, {\it CDMON} \\ \hline

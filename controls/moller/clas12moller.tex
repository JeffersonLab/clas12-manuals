...
M{\o}ller runs first require acceptable CW beam already delivered to the {\bf tagger dump/yoke}.  General beamline documentation should be followed to establish that beam.  {\em (How to reference?  It's now 2 documents on the run wiki.)}
...
\begin{table}[htbp]\centering
    \begin{tabular}{c|c}\toprule[1.5pt]
        ...
        Fast Shut Down (FSD) & Halo \& BOM Masked (M{\o}ller only)\\
        \bottomrule[1.5pt]
    \end{tabular}

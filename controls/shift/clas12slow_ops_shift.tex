...
\begin{document}
\title{CLAS12 Slow Controls Operations Manual - v1.5}
\date{\today}
\begin{abstract}
\end{abstract}
...
\item Use our Hall B GUI that facilitates quickly sending single screenshots to the HBLOG logbook as \texttt{user=clasrun}.  This is accessed via the ``logbook entry'' item from the desktop menu, or via the following script in a terminal:
